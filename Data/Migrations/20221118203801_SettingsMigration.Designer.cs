...
namespace razorsecretsanta.Data.Migrations
{
    ...
    [Migration("20221118203801_SettingsMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("razor_secret_santa.Models.UserDetails", b =>
                {
                    b.HasOne("razor_secret_santa.Models.UserModel", "friend")
                        .WithMany()
                        .HasForeignKey("friendID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("razor_secret_santa.Models.GiftModel", "gift")
                        .WithMany()
                        .HasForeignKey("giftID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("razor_secret_santa.Models.UserModel", "user")
                        .WithMany()
                        .HasForeignKey("userID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
